#ifndef SimMuL1_SimMuL1_h
#define SimMuL1_SimMuL1_h
...
/**\class SimMuL1 SimMuL1.cc MyCode/SimMuL1/src/SimMuL1.cc
 ...
 Description: efficiency studies for L1 muons 
...
class SimMuL1 : public edm::EDFilter 
{
public:

  explicit SimMuL1(const edm::ParameterSet&);
  ~SimMuL1();
...
//  static const float ptscale[33];
  ...
  double rateWeight(double simPT);
